...
public class HolidayBonusTest {
	...
	private double[] result1 = HolidayBonus.calculateHolidayBonus(dataSet1,5000,1000,2000);
	private double[] result2 = HolidayBonus.calculateHolidayBonus(dataSet2,5000,1000,2000);
	private double[] result3 = HolidayBonus.calculateHolidayBonus(dataSet3,5000,1000,2000);
	private double[] result4 = HolidayBonus.calculateHolidayBonus(dataSet4,5000,1000,2000);
	private double[] results= {HolidayBonus.calculateTotalHolidayBonus(dataSet1, 5000, 1000, 2000),
			HolidayBonus.calculateTotalHolidayBonus(dataSet2, 5000, 1000, 2000),
			HolidayBonus.calculateTotalHolidayBonus(dataSet3, 5000, 1000, 2000),
			HolidayBonus.calculateTotalHolidayBonus(dataSet4, 5000, 1000, 2000)};
	@Before
	...
	public void tearDown() throws Exception {
		...
		public void testCalculateHolidayBonusA() {
			...
			assertEquals(14000.0,result2[0],.001);
			assertEquals(1000.0,result2[1],.001);
			assertEquals(4000.0,result2[2],.001);
			assertEquals(13000.0,result2[3],.001);
			
			result = HolidayBonus.calculateHolidayBonus(dataSet3,5000,1000,2000);
			assertEquals(14000.0,result3[0],.001);
			assertEquals(1000.0,result3[1],.001);
			assertEquals(4000.0,result3[2],.001);
			assertEquals(13000.0,result3[3],.001);
			
			result = HolidayBonus.calculateHolidayBonus(dataSet4,5000,1000,2000);
			assertEquals(5000.0,result4[0],.001);
			assertEquals(5000.0,result4[1],.001);
			assertEquals(5000.0,result4[2],.001);
			assertEquals(7000.0,result4[3],.001); // CHANGED 7000->6000
			}
			catch (Exception e) {
...
//		System.out.println("Expected: 22000, Result: "  + HolidayBonus.calculateTotalHolidayBonus(dataSet1, 5000, 1000, 2000));
//		System.out.println("Expected: 32000, Result: "  + HolidayBonus.calculateTotalHolidayBonus(dataSet2, 5000, 1000, 2000));
//		System.out.println("Expected: 32000, Result: "  + HolidayBonus.calculateTotalHolidayBonus(dataSet3, 5000, 1000, 2000));
